...
// 	console.log("Parsed Product Number:", productNumber);
// 	console.log("Parsed Size:", size);
// 	const cleanedQuery = productNumber;
...
// 		  productNumber: baseProduct.productNumber 
// 		})
// 		  .select('_id stock pricing distributor manufacturer size')
// 		  .lean()
// 		  .exec();
...
// 		let sortedEntries = [...stockEntries];
// 		if (size) {
// 		  sortedEntries.sort((a, b) => {
// 			const aSize = a.size ? a.size.toLowerCase() : "";
// 			const bSize = b.size ? b.size.toLowerCase() : "";
// 			const sizeToCompare = size.toLowerCase();
			
// 			const aMatchesSize = aSize.includes(sizeToCompare);
// 			const bMatchesSize = bSize.includes(sizeToCompare);
			
// 			if (aMatchesSize && !bMatchesSize) return -1;
// 			if (!aMatchesSize && bMatchesSize) return 1;
// 			return 0;
// 		  });
// 		}
...
// 		  let relevance = 1;
// 		  if (size && entry.size) {
// 			const entrySize = entry.size.toLowerCase();
// 			const sizeToCompare = size.toLowerCase();
			
// 			relevance = entrySize.includes(sizeToCompare) ? 2 : 0.5;
// 		  }
...
// 		}
// 	  }
// 	  return enrichedProducts.sort((a, b) => b.relevance - a.relevance);
// 	} catch (error) {
// 	  console.error("Error in quicksearch:", error);
// 	  throw new Error("An error occurred while processing the quicksearch.");
// 	}
