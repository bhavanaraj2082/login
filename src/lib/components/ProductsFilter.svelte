 ...
 <div class="w-full  md:ml-10  md:w-full lg:w-full md:mr-4 flex flex-col">
                                            ...
                                            <div class="hidden md:flex items-center">
                                                ...
                                                <div class="flex items-center w-full lg:ml-4 md:ml-4 ">
                                                    ...
                                                    <button 
                                                        ...
                                                        class="text-primary-400 hover:bg-primary-700 hover:text-white border border-primary-400 p-2 ml-4 rounded text-sm lg:ml-10">Add To Cart</button>
                                                </div>
                                            </div>
                                        </div>
                                </div>
    ...
    <div class="flex justify-between items-center mb-2 w-full">
       ...
       <div class="flex items-center justify-between w-full mb-2">
        ...
        <button 
            on:click={() => addToCart(product)} 
            class="text-primary-400 hover:bg-primary-700 hover:text-white border border-primary-400 w-40 p-2 rounded text-sm ml-4">Add To Cart</button>
    </div>
</div>
            {/each}
        </div>
                ...
                <div class="fixed inset-0 flex items-center justify-center bg-slate-500 bg-opacity-70">
                    <div class="bg-white rounded-lg p-6 w-11/12 max-w-sm md:max-w-lg lg:max-w-xl relative">
                        ...
                        <div class="flex justify-between">
                            <button on:click={closeModal} class="bg-primary-400 text-white p-1 mt-2 rounded w-1/3 mr-2 transition-shadow duration-300 hover:shadow-lg hover:shadow-primary-400">
                                Continue Shopping
                            </button>
