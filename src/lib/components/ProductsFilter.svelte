...
<div class="p-4 flex flex-col md:flex-row">
	...
	<div class="hidden md:w-1/3 md:block mb-4 md:mb-0">
		<div class="filter-widget border border-gray-300 rounded-lg shadow-md p-4 w-full">
	...
	<!-- Main Content -->
	<div class="w-full md:ml-10 md:w-[60%] md:mr-4 flex flex-col">
		{#if loading}
		...
		{:else}
			<div class="flex flex-col space-y-4 flex-grow">
				{#each products as product, index}
					<div class="border rounded-lg p-4 shadow-md flex flex-col relative">
						...
						<div class="flex items-start mt-4">
							...
							<div class="flex-grow ml-5">
								...
								<p class="text-gray-600"><strong>Category:</strong> {product.categoryName}</p>
								...
								<div class="flex flex-col md:flex-row items-start justify-between mt-2">
									<div class="hidden md:flex items-center">
										...
										<p class="mr-5 text-gray-600">
											<strong>Size:</strong>
											{product.priceSize[0].size}
										</p>
										<div class="flex items-center">
											...
											<button
												...
												class="text-primary-400 hover:bg-primary-700 hover:text-white border border-primary-400 px-3 py-2 ml-4 rounded text-sm"
												>Add To Cart</button
											>
										</div>
									</div>
						...
						<!-- Smaller -->
						<div class="flex flex-col items-center justify-between md:hidden mx-5">
							...
							<div class="flex items-center justify-between w-full mb-2">
								...
								<button
									on:click={() => addToCart(product)}
									class="text-primary-400 hover:bg-primary-700 hover:text-white border border-primary-400 w-[70px] rounded text-sm ml-4"
									>Add To Cart</button
								>
							</div>
						</div>
			...
			<div class="flex justify-center mt-4 space-x-4">
				...
				<span class="flex items-center text-sm">Page {currentPage}</span>
				<button
		...
		{:else}
			<div class="fixed inset-0 flex items-center justify-center bg-neutral-50 bg-opacity-20">
				<div class="bg-white rounded-lg p-6 w-11/12 max-w-sm md:max-w-lg lg:max-w-xl relative">
					...
					>
					<div class="flex justify-between">
						<a href="/" class="text-gray-500" on:click|preventDefault={closeModal}
							>Continue browsing</a
						>
			...
			<div class="bg-white rounded-lg p-6 w-10/12 md:w-5/12 lg:w-4/12 relative">
				...
				{#if selectedProduct}
					...
					<div class="flex items-center justify-center mt-5">
						...
						<span
							on:click={() => downloadPDF(selectedProduct.safetyDatasheet)}
