                    ...
                    <div class={showManufacturerDropdown ? "space-y-2" : "hidden"}>
                        {#each manufacturers as manufacturer}
                            <label class="flex items-center mb-2 text-gray-600 ml-3 text-sm">
                                <input type="checkbox" on:change={() => toggleManufacturer(manufacturer)}
                        ...
                        <div class="flex-grow ml-5">
                            ...
                            <div class="flex flex-col md:flex-row items-start justify-between mt-2">
                                <div class="hidden md:flex items-center">
                                    <p class="mr-4 text-gray-600"><strong>Price:</strong> {product.priceSize[0].price}</p>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <button 
                                            ...
                                            class="text-primary-400 hover:bg-primary-700 hover:text-white border border-primary-400 px-3 py-2 ml-4 rounded text-sm">Add To Cart</button>
                                    </div>
                                </div>
                            </div>
                        </div>
