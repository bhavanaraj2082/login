		...
		<div class="bg-white p-6 rounded-md border border-gray-300 text-center">
			...
			>
				<div class="flex flex-col md:flex-row md:space-x-4 mb-4">
					<div class="flex-1">
						<label for="order_number" class="block text-sm font-medium text-gray-700 text-start"
							>*Order Number</label
						>
						<input
							type="text"
							...
							class="mt-1 p-2 border border-gray-300 rounded-sm w-full focus:outline-none focus:border-primary-500"
						/>
					...
					<div class="flex-1">
						<label
							for="postalcode"
							class="block text-sm font-medium text-gray-700 text-start sm:mt-0 mt-10"
							>*Shipped to Postal Code</label
						>
						<input
							type="text"
							id="postalcode"
				...
				<div class="flex justify-start">
					<button
						type="submit"
						class="sm:w-1/2 w-full md:w-1/4 px-4 py-2 bg-primary-500 hover:bg-primary-600 text-white rounded-md mt-7"
