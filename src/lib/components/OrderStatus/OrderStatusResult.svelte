...
<div class="bg-white">
  <div class="max-w-7xl mx-auto">
    <div class="mx-4 sm:mx-6 lg:mx-20">
      <h2
        class="font-semibold text-lg text-gray-600 py-5 text-center sm:text-left"
      >
      ...
      >
        ...
        <div
          class="flex flex-col sm:flex-row items-start sm:items-center gap-1 sm:gap-2"
        >
          <div class="text-sm font-semibold text-gray-500">Date:</div>
          <p class="text-sm font-medium text-heading">
        ...
        >
          ...
          {#if remainingProducts.length === 0}
            <div class="text-sm font-semibold text-heading">Shipped</div>
          {:else}
            <div class="text-sm font-semibold text-heading">Pending</div>
          {/if}
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-3">
        {#if isAllActive}
          <AllOrders {orderedproduct} {remainingProducts} />
