<div class="bg-gray-100">
  <div class="min-h-screen flex flex-col items-center justify-center">
    <div class="w-full max-w-4xl p-6 mr-10">
      <div class="flex justify-between mb-0">
        <button id="loginBtn" class=" text-xl font-bold bg-gray-100 px-12 py-6 duration-200 focus:outline-none" 
          onclick="changeColor('login')">Login to your account</button>
        <button id="registerPageBtn" class=" text-xl font-bold bg-gray-100 px-12 py-6 duration-200 focus:outline-none" 
          onclick="changeColor('register')">Create an account</button>
      </div>
  ...
  <script>
    ...
    if (buttonType === 'login') {
      ...
      loginBtn.classList.remove('bg-gray-100');
      registerBtn.classList.add('bg-gray-100');
      registerBtn.classList.remove('bg-white');
    } else if (buttonType === 'register') {
      registerBtn.classList.add('bg-white');
      registerBtn.classList.remove('bg-gray-100');
      loginBtn.classList.add('bg-gray-100');
