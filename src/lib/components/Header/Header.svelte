...
<div class="relative group">
    <a href="/services" class="hover:text-orange-500 flex items-center">
      Services <i class="fa-solid fa-chevron-down ml-1 text-xs"></i>
    </a>
  </div>
  
  <div class="relative group">
    <a href="/documents" class="hover:text-orange-500 flex items-center">
      Documents <i class="fa-solid fa-chevron-down ml-1 text-xs"></i>
    </a>
  </div>
        <div class="relative group">
          <a href="#" class="hover:text-orange-500 flex items-center">
