<section>
  <div class="bg-gray-50 max-w-7xl w-11/12 px-3 mx-auto py-8 text-justify">
    ...
    <div class="space-y-4">
      ...
      <div>
        <h4 class="text-md py-2 text-heading font-semibold">Our Vision</h4>
        <p class="text-justify">
      ...
      <div>
        <h4 class="text-md py-2 text-heading font-semibold">Our Values</h4>
        <div class="space-y-1">
          <p>
      ...
      <div>
        <h4 class="text-md py-2 text-heading font-semibold">Our Products</h4>
        <p class="py-2">
      ...
      <div>
        <h4 class="text-md py-2 text-heading font-semibold">Our Team</h4>
        <p>
