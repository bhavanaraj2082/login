  ...
  <section>
    ...
    <div class="flex flex-wrap sm:flex-nowrap gap-4  mt-4">
      <div class="flex flex-col gap-4 w-full md:max-w-80">
        ...
        <div class={`flex  gap-4  border p-4 ${section.form === activeProfile ? 'shadow-md border-1' : ''}`}>
          <div class=" flex flex-col items-center w-10 h-10 text-center border-2 rounded-full border-primary-400 p-1">
