    ...
    <div class="w-full lg:w-7/12 px-4 py-2  pt-3 rounded-md bg-white shadow h-1/4">
            ...
            <p class="sm:text-sm text-xs font-medium text-primary-500 my-2">
              {#if status === undefined}
                <div class="sm:text-lg text-md font-semibold text-black mb-2">
                 ...
                 We were unable to locate an SDS for the selected product.
              {/if}
            </p>
          </form>
        </div>
      ...
      {#if activeTab === "Certificates of Analysis"}
        <div class="mb-2 max-sm:w-full">
          ...
          <p class="mb-6 sm:text-md text-sm text-description mx-auto">
            To search for a Certificates of Analysis (COA), please enter both
            the product number and the Lot/batch Number.
          </p>
          <form
            method="post"
            action="?/document"
              ...
              return async ({ result }) => {
                ...
                if (result.data) {
                  const certificateOfAnalysis =
                    result.data.certificateOfAnalysis;
          ...
          >
            ...
            <div class="w-full">
              ...
              <label
                for="product-number-sds"
                class="block sm:text-sm text-xs font-medium mb-2{sdsProductNumberError
                  ? 'text-red-500'
                  : 'text-gray-700'}"
              >
                * Lot/batch Number
      ...
      {#if activeTab === "Certificates of Origin"}
        <div class="mb-2 max-sm:w-full">
          ...
          <p class="mb-6 sm:text-md text-sm text-description mx-auto">
            To search for a Certificates of Origin (COO), please enter both the
            product number and the Lot/batch Number.
          </p>
          <form
            method="post"
            action="?/document"
      ...
      {#if activeTab === "Certificates of Quality"}
        <div class="mb-2 max-sm:w-full">
          ...
          <p class="mb-6 sm:text-md text-sm text-description mx-auto">
            To search for a Certificates of Quality (COQ), please enter both the
            product number and the Lot/batch Number.
          </p>
          <form
            method="post"
            ...
            <div class=" w-full">
              ...
              <div class=" w-full">
                ...
                <p class="sm:text-sm text-xs font-medium text-primary-500 my-2">
                  {#if status === undefined}
                    <div
                      class="sm:text-lg text-md font-semibold text-black mb-2"
                    >
                      SDS Not Found
                    </div>
                     We were unable to locate an SDS for the selected product.
      ...
      {#if activeTab === "SafetyData Sheets"}
        ...
        >
          <div class="flex items-center justify-between">
            ...
            <a
              class="text-primary-400 hover:underline flex items-center ml-12 cursor-pointer"
            >
              <Icon
                icon="mynaui:arrow-right"
                width="1.8em"
                height="1.8em"
                class={`  transition-transform duration-400 ${showProductDetailsSafety ? "rotate-45" : "-rotate-45"}`}
              />
            </a>
          </div>
          {#if showProductDetailsSafety}
            <div
              class="mt-4 sm:text-sm text-xs text-description leading-relaxed"
            >
              <p>
        ...
        <div class="flex flex-wrap space-y-4 ml-0 lg:ml-1">
            ...
            <div class="flex items-center justify-between">
              ...
              >
                <Icon
                  ...
                  width="1.8em"
                  height="1.8em"
                  class={`transition-transform duration-400 ${showProductDetailsCertificates ? "rotate-45" : "-rotate-45"}`}
                />
              </a>
            </div>
            ...
            <div class="flex items-center justify-between">
              ...
              >
                <Icon
                  ...
                  width="1.8em"
                  height="1.8em"
                  class={`transition-transform duration-400 ${showLotDetailsCertificates ? "rotate-45" : "-rotate-45"}`}
                />
              </a>
            </div>
          ...
          <div class="bg-white p-4 rounded-md shadow w-full self-start">
            ...
            <p class="mt-4 sm:text-sm text-xs text-description">
              In some cases, a COA may not be available online. If your search
              was unable to find the COA, you can request one by clicking
      ...
      {#if activeTab === "Certificates of Origin"}
        <div class="flex flex-wrap space-y-4 ml-0 lg:ml-1">
            ...
            <div class="flex items-center justify-between">
              ...
              >
                <Icon
                  ...
                  width="1.8em"
                  height="1.8em"
                  class={`transition-transform duration-400 ${showProductDetailsOrigin ? "rotate-45" : "-rotate-45"}`}
                />
              </a>
            </div>
          ...
          >
            <div class="flex items-center justify-between">
              <h3 class="sm:text-md text-sm font-medium text-gray-700">
                How to Find a Lot/Batch Number for COO
              </h3>
              <!-- svelte-ignore a11y-missing-attribute -->
              <a
                class="text-primary-400 hover:underline flex items-center ml-12 cursor-pointer"
              ...
              <div class="mt-4 sm:text-sm text-xs text-description">
                ...
                <ul class="list-disc ml-5">
                  <li>
                    ...
                    <code>09019TO</code> (without the first two letters 'TO').
                  </li>
                  <li>
                    For a lot number with a filling-code such as <code
                      >05427ES-021</code
                    >, enter it as <code>05427ES</code> (without the filling-code
                    '-021').
                  </li>
                  <li>
                    For a lot number with a filling-code such as <code
                      >STBB0728K9</code
                    >, enter it as <code>STBB0728</code> (without the filling-code
                    'K9').
                  </li>
                </ul>
              </div>
          ...
          <div class="bg-white p-4 rounded-md shadow w-full self-start">
            ...
            <p class="mt-4 sm:text-sm text-xs text-description">
              In some cases, a COO may not be available online. If your search
              was unable to find the COO, you can request one.
            </p>
            <div class="flex items-center justify-end mt-4">
              <button
                type="submit"
      ...
      {#if activeTab === "Certificates of Quality"}
        <div class="flex flex-wrap space-y-4 ml-0 lg:ml-1">
            ...
            <div class="flex items-center justify-between">
              ...
              >
                <Icon
                  ...
                  width="1.8em"
                  height="1.8em"
                  class={`transition-transform duration-300 ${showProductDetailsQuality ? "rotate-45" : "-rotate-45"}`}
                />
              </a>
            </div>
          ...
          >
            <div class="flex items-center justify-between">
              <h3 class="sm:text-md text-sm font-medium text-gray-700">
                How to Find a Lot/Batch Number for COQ
              </h3>
              <!-- svelte-ignore a11y-missing-attribute -->
              <a
                class="text-primary-400 hover:underline flex items-center ml-12 cursor-pointer"
          ...
          <div class="bg-white p-4 rounded-md shadow w-full self-start">
            ...
            <p class="mt-4 sm:text-sm text-xs text-description">
              In some cases, a COQ may not be available online. If your search
              was unable to find the COQ, you can request one.
            </p>
            <div class="flex items-center justify-end mt-4">
              <button
                type="submit"
