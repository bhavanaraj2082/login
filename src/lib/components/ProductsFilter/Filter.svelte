  ...
  <div class="p-4 flex flex-col lg:flex-row">
    ...
    <div class="w-full lg:hidden   p-4 mb-4 md:mb-0">
      <div class="border   flex flex-col border-gray-300 rounded-lg md:p-4 w-full">
        <h3 class="text-lg mt-4  font-bold mb-2 text-gray-700 flex items-center" on:click={() => showFilters = !showFilters}>
          ...
          <div class="filter-group border border-gray-300 rounded mb-3">
            ...
            {#if showSearchDropdown}
              <input
                type="text"
                placeholder="Search..."
                class="border hover:border-primary-500 mb-2 rounded p-2 items-center ml-4 w-10/12 text-sm focus:outline-primary-400"
            ...
            <div class={showCategoryDropdown ? "space-y-2" : "hidden"}>
              {#each $categories as category}
                <label class="flex items-center mb-2 ml-3 text-gray-600">
                  <input
                    type="checkbox"
                     class="form-checkbox rounded  accent-primary-600 mr-2 "
