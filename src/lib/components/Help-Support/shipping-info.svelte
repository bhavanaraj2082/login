			...
			<div class=" w-full pb-6 h-full">
				...
				<div>
					...
					<div class="flex flex-col text-sm my-4">
						...
						<label>
							...
							/>
							An additional location/address; original address should
							be maintained
						</label>
					</div>
				</div>
				...
				<div class="mt-4">
					<label class="block text-base"
						>Would you like the new address to become your primary
						address in your online profile?</label
					>
				...
				<div class="mt-4">
					<label class="block text-base"
						>Please indicate the address(es) you would like to
						update:</label
					>
					<div class="flex flex-col text-sm my-4">
						<label class="mb-3">
