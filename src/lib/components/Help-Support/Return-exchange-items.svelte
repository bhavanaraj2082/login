  ...
  <div>
    ...
    <div class="mt-2">
      <label class="block text-sm py-2">
        <input type="radio" name="issue" value="Item is defective or doesn't work" bind:group={issue} class="form-radio w-3.5 h-3.5 text-primary-500 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-primary-500 mr-2"
 required />
        Item is defective or doesn't work
      </label>
      <label class="block text-sm py-2">
        <input type="radio" name="issue" value="Product is damaged but shipping box is OK" bind:group={issue} class="form-radio w-3.5 h-3.5 text-primary-500 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-primary-500 mr-2"
 required />
        Product is damaged, but shipping box is OK
      </label>
      <label class="block text-sm py-2">
        <input type="radio" name="issue" value="Product and shipping box both damaged" bind:group={issue} class="form-radio w-3.5 h-3.5 text-primary-500 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-primary-500 mr-2"
 required />
        Product and shipping box both damaged
      </label>
      <label class="block text-sm py-2">
        <input type="radio" name="issue" value="Missing or incorrect product" bind:group={issue} class="form-radio w-3.5 h-3.5 text-primary-500 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-primary-500 mr-2"
 required />
