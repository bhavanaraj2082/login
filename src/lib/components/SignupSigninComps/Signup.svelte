         ...
         use:enhance={handleFormSubmission}>
            <div class="mb-4 flex flex-col md:flex-row md:space-x-4">
                <div class="flex-1 mb-2 md:mb-0">
                    ...
                    <input type="text" id="username" name="username" bind:value={username} placeholder="Enter your username" class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-primary-400 focus:border-primary-400" />
                    {#if errors.username}
                ...
                <div class="flex-1 mb-2 md:mb-0">
                    ...
                    <input type="email" id="email" name="email" bind:value={email} placeholder="Enter your email" class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-primary-400 focus:border-primary-400" />
                    {#if errors.email}
            ...
            <div class="mb-4 flex flex-col md:flex-row md:space-x-4">
                <div class="flex-1 mb-2 md:mb-0">
                    ...
                    <select id="language" name="language" bind:value={language} class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-primary-400 focus:border-primary-400">
                ...
                <div class="flex-1 mb-2 md:mb-0">
                    ...
                    <select id="location" name="location" bind:value={location} class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-primary-400 focus:border-primary-400">
            ...
            <div class="mb-4">
                ...
                <input type="password" id="password" name="password" bind:value={password} placeholder="Enter your password" class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-primary-400 focus:border-primary-400" />
                {#if errors.password}
            ...
            <div class="mb-4">
                ...
                <input type="password" id="passwordConfirm" name="confirmpassword" bind:value={passwordConfirm} placeholder="Confirm your password" class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-primary-400 focus:border-primary-400" />
            ...
            <div class="mb-4">
                <div class="text-primary-500 font-semibold">TERMS AND CONDITION:</div>
            ...
            <div class="mb-4 hidden md:block text-gray-500">
                <div class="flex flex-col md:flex-row items-start">
                    <div class="font-semibold underline text-md">Note:</div>
