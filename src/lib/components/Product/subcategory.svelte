...
<div class="w-full mb-8 sm:px-4 md:w-11/12 mx-auto max-w-7xl">
  <div class="pl-4 md:pl-0">
    <div class="text-center lg:flex sm:px-6 px-2 lg:px-0 justify-between items-center mb-2">
      <p class="text-heading font-bold text-md lg:text-2xl text-left mb-2 lg:mb-0">
        {subcategories[0]?.category?.name}
      </p>
      <div class="relative">
        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
    ...
    <p class="mt-2 sm:text-base text-sm text-wrap  text-content p-2 lg:p-0 text-center lg:text-left">
      Precision-driven laboratory chemicals perfect for research, analysis, and
      experiments, with top-tier quality and reliability.
    </p>
  </div>
