...
<div class="p-4 md:p-8">
	<div class="m mx-auto">
		...
		<p class="mb-2 text-justify">
			In case you are requesting our consent to use copyrighted material available on our website,
			please make sure that you have checked our <a href="/terms" class="text-primary-500"
				>Site Use Terms</a
			>.
		</p>
		<p class="mb-2 text-justify">
			If you are requesting copyright consent that is not already provided by the “Intellectual
			Property Rights” section, then please fill out the below form, and send it to us. We will
			review your request.
		</p>
		<p class="mb-2 text-justify">
			Please note that sending the below request form does NOT give you any license or consent,
			including implied, to use our copyrighted work unless you receive our explicit consent or if
		...
		>
			<div class="mb-4">
				...
				<input
					...
					id="title"
					name="title"
					class="border rounded w-full md:w-1/2 p-2"
					required
				/>
			</div>
			...
			<div class="mb-4 flex flex-col md:flex-row">
				<div class="mb-2 md:mb-0 md:mr-2 w-full md:w-1/2">
					<label for="postalcode" class="block text-gray-700 font-semibold"
			...
			<fieldset class="mb-4">
				<legend class="font-semibold text-gray-700"
					>Please attach it to this request or share the link.</legend
				>
				<div class="flex flex-col md:flex-row items-start">
					<div class="mb-2 md:mb-0 md:mr-4">
						<input
							...
							name="uploadOption"
							value="file"
							on:change={() => toggleUploadFields('file')}
						/>
					...
					<div class="mb-2 md:mb-0 md:mr-4">
						<input
							...
							name="uploadOption"
							value="url"
							on:change={() => toggleUploadFields('url')}
						/>
				...
				<div class={uploadOption === 'file' ? 'block' : 'hidden'}>
					<label for="file" class="block font-semibold text-gray-700 mt-2"
						>Choose File (.csv, .txt, .pdf)</label
					>
					<div class="relative">
						<input
							type="file"
						...
						/>
						<div
							class="border rounded w-full md:w-1/2 p-2 cursor-pointer flex items-center justify-between"
						>
			...
			<div class="mb-4 p-4">
				<h2 class="text-sm md:w-1/2 font-semibold">
				...
				<textarea
					...
					name="description"
					class="border rounded w-full md:w-1/2 p-2 mt-2"
					rows="4"
				></textarea>
			</div>
			<div class="flex justify-center w-full md:w-1/2 mt-1">
				<button type="submit" class="text-white text-lg w-full md:w-1/2 bg-primary-500 rounded p-1"
					>Submit</button
				>
			</div>
		</form>
