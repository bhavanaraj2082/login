...
<div class="bg-white ">
	<span class="flex items-center gap-2 pt-10">
		<Icon icon="material-symbols:add-notes-outline-rounded" class="sm:w-8 sm:h-8 w-6 h-6 text-heading"  style="stroke-width: 2;"/>
	<h1 class="font-bold sm:text-2xl text-sm  bg-white ">Step 4: Additional notes</h1>
	</span>
