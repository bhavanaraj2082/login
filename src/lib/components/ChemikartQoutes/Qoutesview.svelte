<script>
	...
	import {
	  ...
	  Cusdetails,
	  Delivery
	} from '../../../src/stores/solution_stores';
  ...
  <form method="POST" action="?/qoutes" class="mx-10 p-5 bg-white rounded-lg shadow-lg space-y-4" use:enhance={() => {
		return async({ result }) => {
			let message1 = '';
			let keywordError = '';
			console.log(result); 
	...
	<div class="flex space-x-4 mt-5">
		...
		<a href="https://chemikart.partskeys.com/quotes" class="px-4 py-2 bg-primary-500 text-white rounded hover:bg-primary-500 focus:outline-none focus:ring focus:ring-primary-500 inline-block">
			Back
		</a>
	</div>
</form>