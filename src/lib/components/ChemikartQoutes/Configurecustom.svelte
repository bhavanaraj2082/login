			...
			>
				...
				<div class="relative group">
					...
					<div
						class="opacity-0 group-hover:opacity-100 duration-300 absolute w-80 box-content p-4 border-2 text-sm bg-white"
					>
						CERTAN® capillary bottle provides the benefits of a sealed ampoule with the flexibility
						of a screw-cap bottle, ensuring minimal evaporation even with volatile materials.
					</div>
				</div>
			</button>
			<button
			...
			>
				<div class="mx-6 my-2 flex">
					...
					<div class="relative group">
						...
						>
							ISO 17034 Produced in accordance with internationally recognised requirements for the
							development and production of reference standards and for the competence of reference
							standard manufacturers. Find out more.
						</div>
					</div>
				</div>
			</button>
				...
				<div class="mx-6 my-2 flex">
					...
					<div class="relative group">
						...
						<div
							...
							style="background-color:#fff"
						>
							ISO/IEC 17025 Produced in accordance with internationally recognised requirements for
...
<div class="ml-10">
	...
	<p class="my-5">
		...
		perform well with certain analytical techniques. We may offer a revised mixture in these cases.
	</p>
