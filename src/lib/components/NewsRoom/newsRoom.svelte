...
<div class="p-4 w-10/12 mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-10">
        ...
        <a href={`newsroom/${item.newsLink}`} class=" hover:scale-105 transform transition-all duration-300">
            <div>
                <img src={item.image} alt="img" class="w-full h-40 object-cover mx-auto" />
