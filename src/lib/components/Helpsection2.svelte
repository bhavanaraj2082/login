		...
		>
			...
			>
				<div class="w-full max-w-lg px-2 py-6 rounded-t-xl">
					...
					<div
						class="md:text-md lg:text-lg font-semibold p-2 border hover:border-transparent hover:bg-primary-400 hover:text-white rounded-md group transition-colors duration-300 ease-in-out cursor-pointer"
						on:click={() => {
							toggleHelps();
							goto('/feedback');
						}}
