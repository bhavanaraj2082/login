...
<div class="max-[991px]:block md:flex lg:flex bg-white shadow-lg rounded-lg m-14">
  <!-- <input type="text" name="PartNumber" value={product.productId} /> -->
  ...
  <div class="bg-white shadow-sm rounded-sm p-3 space-x-4 justify-between items-center flex-col lg:flex-row m-3 lg:w-1/3 md:w-3/6">
    ...
    <div class="w-full !ml-0">
      ...
      <div class="w-full mt-3">
        <button class="bg-primary-400 text-white w-full mt-4 rounded-lg py-2 px-6 text-base hover:bg-primary-500">
          <i class="fa-solid fa-cart-shopping"></i>
          Add to Cart
        </button>
        <button class="mt-4 w-full bg-white text-primary-400 border border-primary-400 rounded-lg py-2 px-4 hover:bg-primary-400 hover:text-white">
