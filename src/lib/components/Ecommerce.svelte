        ...
        {#if errorMessage === "success"}
            ...
            <div>
                <label class="flex items-center space-x-2 text-lg">
                    ...
                    <input type="checkbox"  bind:group={selectedNames} class="w-6 h-6 mb-5 form-checkbox rounded text-primary-400 focus:outline-none focus:ring-0" value="I have a question about an existing B2B connection "/>
                    <span class="mb-5 text-xs">I have a question about an existing B2B connection.</span>
                </label>
                <label class="flex items-center space-x-2 text-lg">
                    <input type="checkbox"  bind:group={selectedNames} class="w-6 h-6 mb-5 form-checkbox rounded text-primary-400 focus:outline-none focus:ring-0" value=" I would like have more information about B2B solutions "/>
                    <span class="mb-5 text-xs">I would like have more information about B2B solutions</span>
                </label>
                <label class="flex items-center space-x-2 text-lg">
                    <input type="checkbox"  bind:group={selectedNames} class="w-6 h-6 mb-5 form-checkbox rounded text-primary-400 focus:outline-none focus:ring-0" value=" I would like to be contacted about setting up a B2B connection "/>
                    <span class="mb-5 text-xs">I would like to be contacted about setting up a B2B connection</span>
                </label>
                <label class="flex items-center space-x-2 text-lg">
                    <input type="checkbox"  bind:group={selectedNames} class="w-6 h-6 mb-5 form-checkbox rounded text-primary-400 focus:outline-none focus:ring-0" value=" I would like to know if there is an existing B2B connection for my organization "/>
                    <span class="mb-5 text-xs">I would like to know if there is an existing B2B connection for my organization</span>
                </label>
                <label class="flex items-center space-x-2 text-lg">
                    <input type="checkbox"  bind:group={selectedNames} class="w-6 h-6 mb-5 form-checkbox rounded text-primary-400 focus:outline-none focus:ring-0" value=" I have another question (fill in below Additional details)"/>
                ...
                <div class="w-full mt-3 max-w-full sm:max-w-lg md:max-w-3xl overflow-hidden">
                    <div class="flex flex-col md:flex-row md:space-x-4">
                        <div class="flex-1 mb-4 sm:w-full">
                            <input type="text" name="fname" id="fname" bind:value={fname} class="flex w-full border border-gray-300 p-3 rounded focus:outline-none focus:border-primary-400 focus:shadow-none focus:ring-0 placeholder-gray-400" placeholder="First Name*" />
                            ...
                            <div class="flex-1 mb-4 sm:w-full" >
                                <input type="text" name="lname" id="lname" bind:value={lname} class="flex w-full border border-gray-300 p-3 rounded focus:outline-none focus:border-primary-400 focus:shadow-none focus:ring-0 placeholder-gray-400" placeholder="Last Name*" />
                        ...
                        <div class="flex flex-col md:flex-row md:space-x-4">
                        <div class="flex-1 mb-4 sm:w-full" >
                                <input type="text" name="email" id="email" bind:value={email} class="block w-full border border-gray-300 p-3 rounded focus:outline-none focus:border-primary-400 focus:shadow-none focus:ring-0 placeholder-gray-400" placeholder="Business Email Address*" />
                            ...
                            <div class="flex-1 mb-4 sm:w-full" >
                                <input type="tel" name="number" id="number" bind:value={number} class="block w-full border border-gray-300 p-3 rounded focus:outline-none focus:border-primary-400 focus:shadow-none focus:ring-0 placeholder-gray-400" placeholder="Business Phone*" />
                        ...
                        <div class="flex flex-col md:flex-row md:space-x-4">
                            <div class="flex-1 mb-4 sm:w-full" >
                                <input type="text" name="company" id="company" bind:value={company} class="block w-full border border-gray-300 p-3 rounded focus:outline-none focus:border-primary-400 focus:shadow-none focus:ring-0 placeholder-gray-400" placeholder="Company*" />
                                {#if showErrors && company.length === 0}
                                    <span class="text-red-400 text-xs">Company Name is required</span>
                                {/if}
                            </div>
                                <div class="flex-1 mb-4 sm:w-full" >
                                <input type="text" name="role" id="role" bind:value={role} class="block w-full border border-gray-300 p-3 rounded focus:outline-none focus:border-primary-400 focus:shadow-none focus:ring-0 placeholder-gray-400" placeholder="Role*" />
                        ...
                        <div class="flex flex-col md:flex-row md:space-x-4">
                            <div class="flex-1 mb-4 sm:w-full" >
                                ...
                                class="block w-full border border-gray-300 p-3 rounded focus:outline-none focus:border-primary-400 focus:shadow-none focus:ring-0 placeholder-gray-400"style="background-color: white;">
                        ...
                        <div class="flex-1 mb-4 sm:w-full">
                            <textarea name="details" id="details" bind:value={details} class="w-full p-3 border border-gray-300 rounded focus:outline-none focus:border-primary-400 focus:shadow-none focus:ring-0 placeholder-gray-400 mb-4 h-32" placeholder="Additional Details*"></textarea>
                        ...
                        <div>
                            <label class="flex items-center space-x-2">
                                <input 
                                    ...
                                    name="query" 
                                    bind:value={reason} 
                                    class="w-6 h-6 mb-5 ml-1 form-checkbox rounded text-primary-400 focus:outline-none focus:ring-0 "
                                />
