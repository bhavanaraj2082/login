...
<section class="mt-16 md:px-16 px-5 md:mt-10">
    <div class="hover:text-primary-300 text-primary-500 text-3xl font-semibold mb-7">Chemikart Solutions</div>
...
<h2 class="font-semibold text-3xl font-worksans text-primary-500 ml-3">Contact Our Team</h2>
<form method="POST" action="?/contactus" class="w-full mt-3 max-w-3xl ml-3" use:enhance={() => {
    ...
    <div class="message-container mt-3">
        {#if errorMessage === "success"}
            ...
            <div>
                <p class="mb-5 mt-10 text-lg font-semibold text-primary-500">Select all that apply</p>
            </div>
            <div>
                <label class="flex items-center space-x-2 text-lg">
                    <input type="checkbox"  bind:group={selectedNames} class="w-6 h-6 mb-5 form-checkbox accent-primary-500" value="I have a question about an existing B2B connection "/>
                    <span class="mb-5">I have a question about an existing B2B connection.</span>
                </label>
                <label class="flex items-center space-x-2 text-lg">
                    <input type="checkbox"  bind:group={selectedNames} class="w-6 h-6 mb-5 form-checkbox accent-primary-500" value=" I would like have more information about B2B solutions "/>
                    <span class="mb-5">I would like have more information about B2B solutions</span>
                </label>
                <label class="flex items-center space-x-2 text-lg">
                    <input type="checkbox"  bind:group={selectedNames} class="w-6 h-6 mb-5 form-checkbox accent-primary-500" value=" I would like to be contacted about setting up a B2B connection "/>
                    <span class="mb-5">I would like to be contacted about setting up a B2B connection</span>
                </label>
                <label class="flex items-center space-x-2 text-lg">
                    <input type="checkbox"  bind:group={selectedNames} class="w-6 h-6 mb-5 form-checkbox accent-primary-500" value=" I would like to know if there is an existing B2B connection for my organization "/>
                    <span class="mb-5">I would like to know if there is an existing B2B connection for my organization</span>
                </label>
                <label class="flex items-center space-x-2 text-lg">
                    <input type="checkbox"  bind:group={selectedNames} class="w-6 h-6 mb-5 form-checkbox accent-primary-500" value=" I have another question (fill in below Additional details)"/>
                    <span class="mb-5">I have another question (fill in below Additional details)</span>
                </label>
            </div>
