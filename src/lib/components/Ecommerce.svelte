...
function validatePhoneNumber(location, number) {
	...
	if (!pattern) {
	throw new Error(`No validation pattern found for location: ${location}`);
	}
        ...
        {#if errorMessage === "success"}
            ...
            <div>
                <label class="flex items-center space-x-2 text-lg">
                    ...
                    <input type="checkbox"  bind:group={selectedNames} class="w-4 h-4 mb-5 form-checkbox rounded-sm text-primary-400 focus:outline-none focus:ring-0" value="I have a question about an existing B2B connection "/>
                    <span class="mb-5 text-xs">I have a question about an existing B2B connection.</span>
                </label>
                <label class="flex items-center space-x-2 text-lg">
                    <input type="checkbox"  bind:group={selectedNames} class="w-4 h-4 mb-5 form-checkbox rounded-sm text-primary-400 focus:outline-none focus:ring-0" value=" I would like to have more information about B2B solutions "/>
                    <span class="mb-5 text-xs">I would like to have more information about B2B solutions</span>
                </label>
                <label class="flex items-center space-x-2 text-lg">
                    <input type="checkbox"  bind:group={selectedNames} class="w-4 h-4 mb-5 form-checkbox rounded-sm text-primary-400 focus:outline-none focus:ring-0" value=" I would like to be contacted about setting up a B2B connection "/>
                    <span class="mb-5 text-xs">I would like to be contacted about setting up a B2B connection</span>
                </label>
                <label class="flex items-center space-x-2 text-lg">
                    <input type="checkbox"  bind:group={selectedNames} class="w-4 h-4 mb-5 form-checkbox rounded-sm text-primary-400 focus:outline-none focus:ring-0" value=" I would like to know if there is an existing B2B connection for my organization "/>
                    <span class="mb-5 text-xs">I would like to know if there is an existing B2B connection for my organization</span>
                </label>
                <label class="flex items-center space-x-2 text-lg">
                    <input type="checkbox"  bind:group={selectedNames} class="w-4 h-4 mb-5 form-checkbox rounded-sm text-primary-400 focus:outline-none focus:ring-0" value=" I have another question (fill in Additional details)"/>
                    <span class="mb-5 text-xs">I have another question (fill in Additional details)</span>
                </label>
            </div>
