...
{#each data.records as product}
  ...
  <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 backdrop-blur-sm z-50 transition-opacity"
    ...
    <div class="bg-white rounded-lg w-full max-w-lg p-6 md:p-8 mx-4 md:mx-0 relative shadow-lg"
      ...
      <div class="flex justify-between items-center mb-2 border-b-1 pb-3">
        ...
        <button on:click={cartTogglePopup} class="hover:bg-red-100 text-white rounded font-bold transition-colors duration-300">
          <Icon
            icon="mdi:close"
      ...
      <div class="flex flex-col items-center">
        ...
        <div class="flex justify-between items-center w-full bg-primary-50 p-2 rounded-md border border-gray-200">
      ...
      <div class="flex justify-end gap-5 mt-6 pt-3 border-t-1">
        ...
        <a href="/cart">
          <button class="text-primary-400 px-3 py-1.5 rounded-md font-normal flex gap-2 border-1 border-primary-400 hover:border-primary-500 hover:bg-primary-500 hover:text-white transition-all ease-in-out duration-300 shadow-sm">
            View Cart
