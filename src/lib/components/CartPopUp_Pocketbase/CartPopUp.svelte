<script>
  ...
  <button on:click={toggleCart} class="bg-primary-600 text-white px-4 py-2">Open Cart</button>
                    ...
                    <div class="flex h-full flex-col bg-white shadow-xl">
                        <div class="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                            <div class="flex justify-between items-center pb-4 border-b">
                                ...
                                <button class="text-primary-600" on:click={toggleCart}>
  ...
  <div class="flex items-center py-4 border-b">
      <div class="flex flex-col space-y-4">
          <div class="flex items-center justify-between max-sm:flex-col max-sm:items-center">
              <img src={item.name} alt={item.name} class="w-32 h-24 max-sm:w-24 rounded-md">
              ...
              <div class="ml-4 flex-1 flex justify-between max-sm:ml-0 max-sm:justify-center">
                  ...
                  <button class="ml-4 max-sm:mt-2 text-primary-600" on:click={() => removeItem(item.id)}>
  ...
  {/each}
                        ...
                        <div class="p-4 mt-4 border-t">
                            ...
                            <div class="flex flex-col space-y-4">
                                <button class="bg-primary-500 text-white text-center py-3 rounded-lg font-semibold hover:bg-primary-600">
                                  VIEW CART
                                </button>
