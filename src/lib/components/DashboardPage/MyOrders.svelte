...
<div class="w-full lg:w-11/12 max-w-7xl mx-auto py-2 px-4 bg-gray-50"> 
    ...
    {#if !data?.orders?.length}
        <a href="/products">
            <div class="border-l-8 my-4 border-yellow-300 h-40 flex flex-col items-center justify-center p-6 mb-6 rounded-xl shadow hover:bg-yellow-50 transition-all duration-300 cursor-pointer">
                <div class="flex flex-col items-center text-center">
                    <Icon icon="hugeicons:shopping-bag-add" class="text-4xl mb-4 text-yellow-600" />
                    <p class="font-semibold text-xs md:text-xl text-yellow-600 transition-all duration-300">
