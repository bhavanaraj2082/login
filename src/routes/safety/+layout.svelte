...
<div class="w-11/12 mx-auto max-w-7xl pb-8">
  <h1 class="text-heading font-bold text-xl md:text-2xl ml-2.5 ">Product Safety</h1>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4"> 
        ...
        <div class="p-4 rounded-lg shadow flex flex-col justify-center items-center hover:shadow-md">
          <a href="/safety/hazard-and-precautionary-statements" 
            ...
            <img src="/productsafety/Hazard_Precaution.webp" alt="Hazard_Precaution" class="sm:mb-10 mb-5 w-52 rounded-md" />
