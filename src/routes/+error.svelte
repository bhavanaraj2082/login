...
{:else}
  <div
    class="min-h-[80vh] bg-gray-50 relative max-w-7xl mx-auto mb-12 py-16 px-4"
  >
    <!-- Decorative Hexagonal Shapes -->
    <div
      class="absolute top-1/4 md:left-10 left-2 lg:w-72 w-20 lg:h-80 h-20 bg-primary-100 blur-sm clip-hexagon shadow-xl animate-pulse"
    ></div>
    <div
      class="absolute bottom-2 md:right-12 right-4 lg:w-40 w-20 lg:h-40 h-20 bg-primary-100 clip-hexagon shadow-xl animate-pulse"
    ></div>
    <div
      class="absolute top-0 md:right-20 right-4 md:w-20 w-10 md:h-20 h-10 mt-3 bg-primary-100 clip-hexagon shadow-lg animate-pulse"
    ></div>

    <!-- Centered Content -->
    <div
      class="flex items-center justify-center px-4 sm:px-6 lg:px-8 relative z-10"
    >
      <div class="w-full max-w-5xl mx-auto">
        <div class="flex flex-col md:flex-row items-center">
          ...
          <!-- Text Section -->
          <div
            class="w-full md:w-1/2 flex flex-col md:pl-8 text-center md:text-left"
          >
            <div class="mb-1">
              <p
                class="text-4xl font-extrabold text-black tracking-wide animate-bounce"
              >
                Oops!
              </p>
              <!-- <span class="whitespace-nowrap text-2xl font-semibold mt-2 text-gray-800">
            ...
            <div class="mb-8">
              ...
              <ul class="sm:list-disc pl-5 text-gray-700 text-md">
                <li>
                  Visit our <a
                    href="/products"
